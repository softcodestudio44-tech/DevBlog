      ...
      <div className="min-h-screen pt-24 pb-12 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          >
            <Link
              to="/"
              className="inline-flex items-center gap-2 text-white hover:text-primary-300 transition-colors mb-6"
            >
            ...
            <GlassCard className="mb-8">
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {isAuthor && (
                    <Link
                      to={`/edit-post/${id}`}
                      className="p-2 rounded-xl hover:bg-white/5 text-white hover:text-primary-300 transition-colors"
                      title="Edit post"
                    >
              ...
              <div className="flex items-center gap-4 pt-6 border-t border-white/10">
                ...
                <button className="flex items-center gap-2 text-white hover:text-primary-300 transition-colors ml-auto">
